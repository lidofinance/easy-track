...
** Deploy of easy track

Здесь я хочу развернуть easy track, пока для валидаторов
только.

[TODO:gmm] - Как я могу проверить, что деплой прошел
успешно? Надо ли это проверять вообще?

[TODO:gmm] - Я не вполне понимаю, почему мы должны
использовать fixtures таким образом


** TODO Making vote
** TODO Send objection
** TODO Get voting results
