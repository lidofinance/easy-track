...
def test_create_evm_script_node_operator_disabled(
    ...
    node_operators_registry_stub.setActive(NODE_OPERATOR_ID, False)
...
def test_create_evm_script_new_staking_limit_too_low(
    ...
    node_operators_registry_stub.setStakingLimit(NODE_OPERATOR_ID, 370)
...
def test_create_evm_script_new_staking_limit_less_than_total_signing_keys(
    ...
    node_operators_registry_stub.setTotalSigningKeys(NODE_OPERATOR_ID, 300)
