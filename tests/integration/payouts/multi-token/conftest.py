...
def top_up_balances(lido_contracts, dai_ward):
    set_account_balance(lido_contracts.aragon.agent.address)
    set_account_balance(lido_contracts.aragon.voting.address)
    set_account_balance(dai_ward.address)
...
@pytest.fixture(scope="module")
def ensure_agent_dai_balance(dai, interface, lido_contracts, dai_ward):
