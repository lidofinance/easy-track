...
contract CuratedModuleSubmitExitRequestHashes is TrustedCaller, IEVMScriptFactory {
    ...
    INodeOperatorsRegistry public immutable curatedNodeOperatorsRegistry;
    ...
    constructor(
        ...
        address _curatedNodeOperatorsRegistry,
        address _validatorsExitBusOracle
    ) TrustedCaller(_trustedCaller) {
        curatedNodeOperatorsRegistry = INodeOperatorsRegistry(_curatedNodeOperatorsRegistry);
