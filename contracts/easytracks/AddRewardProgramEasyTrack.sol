...
contract AddRewardProgramEasyTrack is TrustedSender {
    ...
    function enactMotion(uint256 _motionId) external {
        ...
        _validateMotionData(_rewardProgram);
        topUpRewardProgramEasyTrack.addRewardProgram(_rewardProgram);
        motionsRegistry.enactMotion(_motionId);
    }

    function _validateMotionData(address _rewardProgram) private view {
        require(!topUpRewardProgramEasyTrack.isAllowed(_rewardProgram), "ALREADY_ALLOWED");
    }
