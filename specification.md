...
- **`IMiniMeToken governanceToken`** - address of governance token. Token has to implement [MiniMeToken]() interface. Only holders of this token can submit objections.
